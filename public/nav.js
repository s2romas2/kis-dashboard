...
(function () {
  const MENUS = [
    { t: '시장', items: [
      ...
      ['/leadsig.html', '📡 주도주 신호', '주봉 4·13·26·52주 정배열·데드크로스'],
      ['/ranktable.html', '🗂️ 업종 랭크테이블', '월별 수익률 순위표 + 상승 화살표'],
    ]},
    { t: '산업', items: [
      ['/defense.html', '🛡️ 방산 맵', '무기 밸류체인·방산 기업 지도'],
      ['/semi.html', '💠 반도체 소부장 맵', '8대공정별 기업·제품 사진 지도'],
      ['/pcycle.html', '🔄 반도체 P→Q 추적', '판가→물량 사이클 전환 지표'],
      ['/sectorflow.html', '🌊 섹터 흐름·병목', '밸류체인 단계별 병목·정치 변수'],
      ['/power.html', '⚡ 전력 수요 파이프라인', '미국 계획 발전소·데이터센터 수요 추적'],
      ['/optics.html', '🔦 광통신 맵', 'AI 광 인터커넥트 밸류체인·병목·지정학'],
    ]},
    { t: '실적', items: [
    ...
    { t: '트렌드', items: [
      ...
      ['/amazon.html', '🛒 아마존 베스트셀러', 'K뷰티 브랜드 순위 일일 추적'],
    ]},
    { t: '리서치', items: [
      ['/reports.html', '📑 리포트', '산업·종목·해외(번역) 리서치'],
      ['/blog.html', '📓 블로그', '구독 블로거 글 자동 수집'],
      ['/calls.html', '📞 콜 노트 🔒', '팀더윤쎈 콜 아카이브 (암호)'],
      ['/lectures.html', '🎓 강의 노트 🔒', '강의 녹음+핵심 요약 (암호)'],
    ]},
  ];
